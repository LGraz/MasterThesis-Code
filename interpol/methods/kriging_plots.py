...
pix.x_axis = "gdd"
pix.plot_ndvi()
obj = pix.itpl("ok", itpl.ordinary_kriging, ok_args={
...
try:  # get 'median of param'
    ...
    pixels2 = data_handle.get_pixels(0.01, seed=4321)
    param_list = []
    for pix in pixels2:
        pix.x_axis = "gdd"
        obj, ok = pix.itpl("ok", itpl.ordinary_kriging,
...
# for pix in pixels:
#     pix.plot_ndvi()
#     obj, ok = pix.itpl(it"ok", pl.orordinary_kriging,
...
obj = pix.itpl(name_ml, itpl.ordinary_kriging,
...
obj = pix.itpl(name_med, itpl.ordinary_kriging,
...
def plot_kriging_param(pix, psill_range_nugget, **plot_args):
    ...
    pix.itpl(name, itpl.ordinary_kriging, ok_args={"variogram_model": "gaussian", "variogram_parameters": [
